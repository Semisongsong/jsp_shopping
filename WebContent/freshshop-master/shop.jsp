...
<c:if test="${ message_C==1 }">
		<script>
			alert("상품이 장바구니에 등록되었습니다..");
		</script>
	</c:if>
	<c:if test="${ message_C==2 }">
		<script>
			alert("상품이 장바구니에 등록에 실패했습니다.");
		</script>
	</c:if>
	
	<c:if test="${ message_ok==1 }">
		<script>
			alert("상품이 장바구니에 등록되었습니다..");
		</script>
	</c:if>
	
	<c:if test="${ message_ok==2}">
		<script>
			alert("상품이 장바구니에 등록되었습니다..");
		</script>
	</c:if>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h2>Shop</h2>
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="ShoppingServlet?command=Main">Home</a></li>
											...
											<div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                ...
                                                <div class="box-img-hover">
                                                    <div class="type-lb">
														...
														<img src="./freshshop-master/upload/${list.image}" class="img-fluid" alt="Image">
														  <input type="hidden" name="file" value="${list.image}">
														<div class="mask-icon">
															<<ul>
                                                            <li><a href="/123/ShoppingServlet?command=shopD&num=${list.num}" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Compare"><i class="fas fa-sync-alt"></i></a></li>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                                          <c:choose>
                        <c:when test="${sessionScope.USER != null}">
															<a class="cart" href="javascript:document.product_form.submit();">Add to Cart</a>  </c:when>
														     <c:otherwise>
                           <c:if test="${sessionScope.USER == null}">
                              <a class="btn hvr-hover" data-fancybox-close="" href="<%=request.getContextPath()%>/freshshop-master/login.jsp">Add to Cart</a>
													...
													<div class="why-text">
														<h4><a href="/123/ShoppingServlet?command=shopD&num=${list.num}">${list.name}</a></h4>
                                    ...
                                    <a class="list-group-item list-group-item-action" href="#sub-men1" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">Fruits & Drinks <small class="text-muted">(100)</small>
										...
										<div class="list-group-collapse sub-men">
											<a class="list-group-item list-group-item-action"
												href="#sub-men2" data-toggle="collapse"
									...
									<ul>
										<li>
											<p>
												...
												Days 3756 <br>Preston Street Wichita,<br> KS 67213
											</p>
										</li>
										<li>
											<p>
