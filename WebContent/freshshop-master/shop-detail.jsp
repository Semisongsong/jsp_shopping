...
function logchk() {
   ...
   <!-- Start Main Top -->
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="<%=request.getContextPath()%>/freshshop-master/images/logo.png" class="logo" alt=""></a>
                </div>
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav ml-auto" data-in="fadeInDown"
						...
						<li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/freshshop-master/about.jsp">About
								Us</a></li>
						<li class="dropdown"><a
							class="nav-link dropdown-toggle arrow" href="<%=request.getContextPath()%>/ShoppingServlet?command=shop">Shop</a>
							</li>						
            ...
            <div class="side">
                ...
                <li class="cart-box">
                    <ul class="cart-list">
                        <li>
                            <a href="#" class="photo"><img src="<%=request.getContextPath()%>/freshshop-master/images/img-pro-01.jpg" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Delica omtantur </a></h6>
                            <p>1x - <span class="price">$80.00</span></p>
                        </li>
                        <li>
                            <a href="#" class="photo"><img src="<%=request.getContextPath()%>/freshshop-master/images/img-pro-02.jpg" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Omnes ocurreret</a></h6>
                            <p>1x - <span class="price">$60.00</span></p>
                        </li>
                        <li>
                            <a href="#" class="photo"><img src="<%=request.getContextPath()%>/freshshop-master/images/img-pro-03.jpg" class="cart-thumb" alt="" /></a>
    ...
    <!-- Start Shop Detail  -->
    <form class="product_form" name="product_form" action="<%=request.getContextPath()%>/ShoppingServlet?command=gocart"  method="post">
            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="./freshshop-master/upload/${dto.image}" alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="./freshshop-master/upload/${dto.image}"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="./freshshop-master/upload/${dto.image}"> </div>
                        </div>
                        ...
                        <ol class="carousel-indicators">
                            <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                                <img class="d-block w-100 img-fluid" src="./freshshop-master/upload/${dto.image}" alt="" />
                            </li>
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                   ...
                   <input type="hidden" name="num" value="${dto.num}">
                        ...
                        <h5> <del>₩ 6000  </del> ${dto.price}</h5>
                         <input type="hidden" name="price" value="${dto.price}">
                        <p class="available-stock"><span> ${dto.amount} / <a href="#"> 8 sold </a></span><p>
						...
						<ul>
							<li>
								<div class="form-group quantity-box">
									...
									<input class="form-control" value="1" min="1" max="20" type="number" name="amount">
									<input type="hidden" name="abcd" value="2">
								</div>
							</li>
						</ul>
                     ...
                     <c:choose>
                        <c:when test="${sessionScope.USER != null}">
                           <a class="btn hvr-hover" data-fancybox-close="" href="#">Buy New</a>
								<a class="btn hvr-hover" data-fancybox-close="" href="javascript:document.product_form.submit();">Add to cart</a>
                        </c:when>

                        <c:otherwise>
                           <c:if test="${sessionScope.USER == null}">
                              <a class="btn hvr-hover" data-fancybox-close="" href="#">Buy New</a>
								<a class="btn hvr-hover" data-fancybox-close="" href="<%=request.getContextPath()%>/freshshop-master/login.jsp">Add to cart</a>
                           </c:if>
                        </c:otherwise>
                     </c:choose>
