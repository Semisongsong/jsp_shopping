...
<!--[if lt IE 9]>
      ...
      <script src="https://oss.maxcdn.com/libs/respond.<%=request.getContextPath()%>/freshshop-master/js/1.4.2/respond.min.js"></script>
    <![endif]-->
		...
		<nav
			...
			<c:forEach var="list" items="${list}">
						<li><a href="#" class="photo"><img
								src="./freshshop-master/upload/${list.image}"
								class="cart-thumb" alt="" /></a>
							<h6>
								<a href="#">${list.name}</a>
							</h6>
							<p>
								1x - <span class="price">${list.price}</span>
							</p></li>
			</c:forEach>
						
						<li class="total"><a href="/123/ShoppingServlet?command=mycart"
	...
	<div id="slides-shop" class="cover-slides">
		<ul class="slides-container">
			<li class="text-center"><img
				src="<%=request.getContextPath()%>/freshshop-master/images/banner-01.jpg"
				alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p>
								<a class="btn hvr-hover" href="<%=request.getContextPath()%>/ShoppingServlet?command=shop">Shop New</a>
							</p>
						</div>
					</div>
				</div></li>
			<li class="text-center"><img
				src="<%=request.getContextPath()%>/freshshop-master/images/banner-02.jpg"
				alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
			...
			<li class="text-center"><img
				src="<%=request.getContextPath()%>/freshshop-master/images/banner-03.jpg"
				alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="shop-cat-box">
						<img class="img-fluid"
							src="<%=request.getContextPath()%>/freshshop-master/images/categories_img_01.jpg"
							alt="" /> <a class="btn hvr-hover" href="#">Lorem ipsum
							dolor</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="shop-cat-box">
						<img class="img-fluid"
							src="<%=request.getContextPath()%>/freshshop-master/images/categories_img_02.jpg"
							alt="" /> <a class="btn hvr-hover" href="#">Lorem ipsum
							dolor</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="shop-cat-box">
						<img class="img-fluid"
							src="<%=request.getContextPath()%>/freshshop-master/images/categories_img_03.jpg"
							alt="" /> <a class="btn hvr-hover" href="#">Lorem ipsum
							dolor</a>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<img class="img-fluid"
							src="<%=request.getContextPath()%>/freshshop-master/images/add-img-01.jpg"
							alt="" />
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<img class="img-fluid"
							src="<%=request.getContextPath()%>/freshshop-master/images/add-img-02.jpg"
							alt="" />
					</div>
				</div>
			</div>
				...
				<div class="col-lg-3 col-md-6 special-grid best-seller">
					<div class="products-single fix">
						<div class="box-img-hover">
							...
							<img
								src="<%=request.getContextPath()%>/freshshop-master/images/img-pro-04.jpg"
								class="img-fluid" alt="Image">
							<div class="mask-icon">
								<ul>
									<li><a href="#" data-toggle="tooltip"
			...
			<div class="row">
				<div class="col-md-6 col-lg-4 col-xl-4">
					<div class="blog-box">
						<div class="blog-img">
							<img class="img-fluid"
								src="<%=request.getContextPath()%>/freshshop-master/images/blog-img.jpg"
								alt="" />
						</div>
				...
				<div class="col-md-6 col-lg-4 col-xl-4">
					<div class="blog-box">
						<div class="blog-img">
							<img class="img-fluid"
								src="<%=request.getContextPath()%>/freshshop-master/images/blog-img-01.jpg"
								alt="" />
						</div>
						<div class="blog-content">
							<div class="title-blog">
				...
				<div class="col-md-6 col-lg-4 col-xl-4">
					<div class="blog-box">
						<div class="blog-img">
							<img class="img-fluid"
								src="<%=request.getContextPath()%>/freshshop-master/images/blog-img-02.jpg"
								alt="" />
						</div>
						<div class="blog-content">
							<div class="title-blog">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="footer-link">
							<h4>Information</h4>
							<ul>
								<li><a href="<%=request.getContextPath()%>/freshshop-master/about.jsp">About Us</a></li>
