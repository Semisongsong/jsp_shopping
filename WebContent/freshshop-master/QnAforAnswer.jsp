				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					...
					<div class="login-box">
						<select onchange="if(this.value) location.href=(this.value);"
							...
							<option>목록</option>
							<option value="../login/login.jsp">로그인</option>
							<option>내 정보</option>
							<option>기타 등등</option>
     ...
     <div class="shop-detail-box-main">
        <div class="container">
                    ...
                    <!-- 답변이 없을 경우 여기 주석부터 다음 주석까지 삭제하면 원글 폼만 보입니다. -->        
                       <form class="product_form" name="qna_form" action="<%=request.getContextPath()%>/QnAServlet?command=writerep" method="post">    
                            <div class="order-box">
                                <div class="title-left">
                                    <h2>ANSWER </h2>
                                </div>
                                <input type="hidden" name="originnum" value="${dto.num}">
                               
                                <div class="d-flex">
                                    <input
											type="text" class="form-control" id="enrollname" name="title"
											placeholder="Your title" required
											data-error="Please enter your title" value="[Re] "></div>
                                ...
                                <div class="media mb-3">
										<textarea class="form-control" id="message" name="contents"
											...
											data-error="Write your contents" required>
											</textarea>
